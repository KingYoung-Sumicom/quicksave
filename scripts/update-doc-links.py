...
ZH_TW_FILES = [
    ...
    "docs/plans/claude-message-types-reference.zh-TW.md",
    "docs/research/cli-coding-agents-evaluation.zh-TW.md",
    "docs/plans/component-refactoring-guidelines.zh-TW.md",
...
EXTERNAL_FILES = [
    ...
    "docs/plans/codex-integration-plan.md",
    "docs/references/codex-app-server/implementation-plan.md",
    "docs/superpowers/plans/2026-04-13-sdk-v1-provider.md",
    "docs/superpowers/plans/2026-04-13-provider-abstraction.md",
    "docs/superpowers/plans/2026-04-11-query-api-migration.md",
