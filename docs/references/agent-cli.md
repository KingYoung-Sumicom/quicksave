...
| `QUICKSAVE_CODEX_BACKGROUND_COMPLETIONS=0` | Disable experimental Codex post-turn native command completion continuation. Codex native Bash, approvals, Guardian, and sandbox behavior are unchanged. |
