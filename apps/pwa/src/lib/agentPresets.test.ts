...
describe('agentPresets', () => {
  ...
  describe('modelSupports1m', () => {
    ...
    it('returns true for sonnet and opus', () => {
  ...
  describe('clampContextWindowForModel', () => {
    ...
    it('preserves 1M on sonnet', () => {
      expect(clampContextWindowForModel('claude-sonnet-4-6', 1_000_000)).toBe(1_000_000);
    });

    it('passes 1M through for opus', () => {
